...
const navItems = [
  ...
  { to: "/ticket-types", label: "Ticket Types", icon: (
    ...
    <div className={`flex flex-col h-full ${mobile ? "" : "w-64"}`}>
      ...
      <div className="px-5 py-5 border-b border-slate-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-extrabold text-white text-sm">ParkingPOS</p>
    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      {sidebarOpen && (
        <div className="lg:hidden fixed inset-0 z-50 flex">
          ...
          <div className="relative w-64 bg-slate-900 flex flex-col z-10">
            <Sidebar mobile />
          </div>
        </div>
      )}
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* Mobile topbar */}
        <div className="lg:hidden flex items-center px-4 py-3 bg-white border-b border-slate-200 shadow-sm">
          <button onClick={() => setSidebarOpen(true)} className="text-slate-600 mr-3">
            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" />
            </svg>
          </button>
          <span className="font-bold text-slate-800">ParkingPOS Admin</span>
        </div>
